(function (window, $) {
	...
	var Stag = function () {
		...
		function setDivHeight(element, others) {
			...
			//WL and used below in newHeight
			var navHeight = $('.site-header').outerHeight(true)
			...
			var newHeight = windowHeight - offsetHeight - parseInt( $('html').css('margin-top') ) - navHeight;
